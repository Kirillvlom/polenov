...
<style type="text/css">
  ...
  .all_user span{
	...
	<div class="center-component">
        ...
        <li style="background-color: rgba(149, 145, 145, 0.22);"><a href="all_museum.php">Все музеи</a></li>
				<li><a href="../ws-user/out.php">Выйти</a></li>
			</menu>
		</div>	
		<div class="content"> 
			<div class="title"><span>Все музеи  </span></div>  
			<div class="setting">
                <form action="save_museum.php" method="post">
     ...
     <? 
                       include('../bd.php');
                         ...
                         $museum_q = 0;
                          do{ $museum_q++;
                           echo "<div class='all_user'>
								         <input type='checkbox' name='select[]' value='".$row['id_museum']."' > 
                         <span>id : ".$row['id_museum']."</span>
                         <span style='color:red;'>Название музея :</span><span>".$row['name_museum']."</span> 
                         <span style='color:red;'> Адрес : </span> <span>
                            <a  style='color:blue; text-deco'  target='_blank' href='".$row['link_museum']."'>Ссылка</a>
                         </span>
                        ...
                        echo "<br>";
                        echo('<span style="font-size:25px;">Список пуст </span>');
                       
                       }
       ?>             
                        </div>       
                      </div>
                      <span>Всего записей : <?echo $museum_q;?> </span> <br>
